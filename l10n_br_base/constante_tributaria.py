...
MOTIVO_DESONERACAO_ICMS_FROTISTA_LOCADORA = '04'
MOTIVO_DESONERACAO_ICMS_DIPLOMATICO_CONSULAR = '05'
MOTIVO_DESONERACAO_ICMS_UTILITARIOS_AMAZONIA = '06'
MOTIVO_DESONERACAO_ICMS_SUFRAMA = '07'
MOTIVO_DESONERACAO_ICMS_OUTROS = '09'
...
ORIGEM_MERCADORIA = (
    ...
    ('4', '4 - Nacional - produção feita em conformidade com os processos '
          'produtivos básicos de que tratam o decreto-lei nº 288/67, e as '
          'leis nº 8.248/91, nº 8.387/91, nº 10.176/01 e nº 11.484/07'),
...
ST_ICMS_OUTRAS = '90'
ST_ICMS_CALCULA_PROPRIO = (ST_ICMS_INTEGRAL, ST_ICMS_ST, ST_ICMS_REDUCAO,
...
ST_ICMS_DESONERADO = (ST_ICMS_REDUCAO, ST_ICMS_ISENTA_COM_ST,
                      ST_ICMS_ISENTA, ST_ICMS_NAO_TRIBUTADA,
                      ST_ICMS_SUSPENSAO, ST_ICMS_REDUCAO_COM_ST,
                      ST_ICMS_OUTRAS,)
ST_ICMS_CALCULA_PROPRIO_COM_MOTIVO_DESONERACAO = (ST_ICMS_ISENTA,
                                                  ST_ICMS_NAO_TRIBUTADA,
                                                  ST_ICMS_SUSPENSAO,)
ST_ICMS_DESONERADO_TOTAL = (ST_ICMS_ISENTA_COM_ST, ST_ICMS_ISENTA,
                            ST_ICMS_NAO_TRIBUTADA, ST_ICMS_SUSPENSAO,)
ST_ICMS_DESONERADO_ZERA_ICMS_PROPRIO = (ST_ICMS_ISENTA, ST_ICMS_NAO_TRIBUTADA,
                                        ST_ICMS_SUSPENSAO)

ST_ICMS_ZERA_ICMS_PROPRIO = (ST_ICMS_ANTERIOR,)
...
ST_ICMS_SN = (
    ...
    ('201', '201 - Tributada com permissão de crédito e cobrança de ICMS'
            ' por ST'),
    ('202', '202 - Tributada sem permissão de crédito e cobrança de ICMS '
            'por ST'),
    ('203', '203 - Isento de ICMS para a faixa de receita bruta e cobrança '
            'de ICMS por ST'),
    ('300', '300 - Imune'),
...
ST_PIS = (
    ...
    ('02',
     '02 - Tributável - BC = valor da operação (alíquota diferenciada)'),
    ('03', '03 - Tributável - BC = quantidade vendida × alíquota por unidade'
           ' de produto'),
    ...
    ('55', '55 - Operação com direito a crédito - vinculada a receitas '
...
ST_PIS_ENTRADA = (
    ('50', '50 - Operação com direito a crédito - vinculada exclusivamente'
           ' a receita tributada no mercado interno'),
    ('51', '51 - Operação com direito a crédito - vinculada exclusivamente'
           ' a receita não tributada no mercado interno'),
    ('52', '52 - Operação com direito a crédito - vinculada exclusivamente'
    ...
    ('62', '62 - Crédito presumido - operação de aquisição vinculada'
           ' exclusivamente a receita de exportação'),
    ('63', '63 - Crédito presumido - operação de aquisição vinculada'
           ' a receitas tributadas e não-tributadas no mercado interno'),
    ('64', '64 - Crédito presumido - operação de aquisição vinculada'
           ' a receitas tributadas no mercado interno e de exportação'),
    ('65', '65 - Crédito presumido - operação de aquisição vinculada'
           ' a receitas não-tributadas no mercado interno e de exportação'),
    ('66', '66 - Crédito presumido - operação de aquisição vinculada'
           ' a receitas tributadas e não-tributadas no mercado interno,'
           ' e de exportação'),
    ('67', '67 - Crédito presumido - outras operações'),
    ('70', '70 - Operação de aquisição sem direito a crédito'),
...
ST_PIS_SAIDA = (
    ('01', '01 - Tributável - BC = valor da operação '
           '(alíquota normal - cumulativo/não cumulativo)'),
    ('02', '02 - Tributável - BC = valor da operação '
           '(alíquota diferenciada)'),
    ('03', '03 - Tributável - BC = quantidade vendida ×'
...
CLASSE_CONSUMO_AGUA = (
    ('00', 'Registro consolidando os documentos de consumo residencial'
           ' até R$ 50,00'),
    ('01', 'Registro consolidando os documentos de consumo residencial'
           ' de R$ 50,01 a R$ 100,00'),
    ('02', 'Registro consolidando os documentos de consumo residencial'
           ' de R$ 100,01 a R$ 200,00'),
    ('03', 'Registro consolidando os documentos de consumo residencial'
           ' de R$ 200,01 a R$ 300,00'),
    ('04', 'Registro consolidando os documentos de consumo residencial'
           ' de R$ 300,01 a R$ 400,00'),
    ('05', 'Registro consolidando os documentos de consumo residencial'
           ' de R$ 400,01 a R$ 500,00'),
    ('06', 'Registro consolidando os documentos de consumo residencial '
           'de R$ 500,01 a R$ 1000,00'),
    ('07', 'Registro consolidando os documentos de consumo residencial'
           ' acima de R$ 1.000,01'),
    ('20', 'Registro consolidando os documentos de consumo'
           ' comercial/industrial até R$ 50,00'),
    ('21', 'Registro consolidando os documentos de consumo'
           ' comercial/industrial de R$ 50,01 a R$ 100,00'),
    ('22', 'Registro consolidando os documentos de consumo'
           ' comercial/industrial de R$ 100,01 a R$ 200,00'),
    ('23', 'Registro consolidando os documentos de consumo'
           ' comercial/industrial de R$ 200,01 a R$ 300,00'),
    ('24', 'Registro consolidando os documentos de consumo'
           ' comercial/industrial de R$ 300,01 a R$ 400,00'),
    ('25', 'Registro consolidando os documentos de consumo'
           ' comercial/industrial de R$ 400,01 a R$ 500,00'),
    ('26', 'Registro consolidando os documentos de consumo'
           ' comercial/industrial de R$ 500,01 a R$ 1.000,00'),
    ('27', 'Registro por documento fiscal de consumo'
           ' comercial/industrial acima de R$ 1.000,01'),
    ('80', 'Registro consolidando os documentos de consumo de órgão público'),
    ('90', 'Registro consolidando os documentos de outros tipos de consumo'
           ' até R$ 50,00'),
    ('91', 'Registro consolidando os documentos de outros tipos de consumo'
           ' de R$ 50,01 a R$ 100,00'),
    ('92', 'Registro consolidando os documentos de outros tipos de consumo'
           ' de R$ 100,01 a R$ 200,00'),
    ('93', 'Registro consolidando os documentos de outros tipos de consumo'
           ' de R$ 200,01 a R$ 300,00'),
    ('94', 'Registro consolidando os documentos de outros tipos de consumo'
           ' de R$ 300,01 a R$ 400,00'),
    ('95', 'Registro consolidando os documentos de outros tipos de consumo'
           ' de R$ 400,01 a R$ 500,00'),
    ('96', 'Registro consolidando os documentos de outros tipos de consumo'
           ' de R$ 500,01 a R$ 1.000,00'),
    ('97', 'Registro consolidando os documentos de outros tipos de consumo'
           ' acima de R$ 1.000,01'),
...
NATUREZA_JURIDICA = (
    ...
    ('2313', 'Empresa individual de responsabilidade limitada '
             '(de natureza simples)'),
)
...
#
# Definições para a emissão e controle da CF-e
#
AMBIENTE_CFE = (
    ('1', 'Produção'),
    ('2', 'Homologação'),
)
AMBIENTE_CFE_DICT = dict(AMBIENTE_NFE)
