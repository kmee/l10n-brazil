...
from mdfelib.v3_00 import evCancMDFe, evEncMDFe
...
class SpedDocumento(models.Model):
    ...
    def _prepare_modal(self):
        ...
        vehicle.set_placa(misc.punctuation_rm(self.license_plate))
