...
class ContractContract(models.Model):
    ...
    # Add this field to satisfy l10n_br_fiscal during model setup
    fiscal_line_ids = fields.One2many(
        comodel_name="contract.line",
        inverse_name="contract_id",
        string="Fiscal Lines",
        compute="_compute_fiscal_line_ids",
        readonly=True,
    )

    def _compute_fiscal_line_ids(self):
        for rec in self:
            rec.fiscal_line_ids = rec.contract_line_ids
