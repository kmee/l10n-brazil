...
class AccountTax(models.Model):
    ...
    def _add_tax_details_in_base_line(self, base_line, company, rounding_method=None):
        ...
        if record and hasattr(record, 'fiscal_operation_id') and record.fiscal_operation_id:
    ...
    def _add_br_tax_details_in_base_line(self, base_line, company, rounding_method=None):
        ...
        tax_details['raw_total_excluded'] = taxes_computation['total_excluded'] / rate if rate else 0.0
        tax_details['raw_total_included_currency'] = taxes_computation['total_included']
        tax_details['raw_total_included'] = taxes_computation['total_included'] / rate if rate else 0.0
