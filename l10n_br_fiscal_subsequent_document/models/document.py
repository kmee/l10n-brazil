...
class Document(models.Model):
    ...
    def action_document_cancel(self):
        ...
        if any(
            ...
            for doc in self.document_subsequent_ids.mapped("subsequent_document_id")
        ):
            raise UserError(
                _(
    ...
    def exec_after_SITUACAO_EDOC_AUTORIZADA(self, old_state, new_state):
        result = super().exec_after_SITUACAO_EDOC_AUTORIZADA(old_state, new_state)
