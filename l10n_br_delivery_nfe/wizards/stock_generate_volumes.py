...
class StockGenerateVolumes(models.TransientModel):
    """
    This wizard allow for pre-generation of picking volumes.
    If triggerd, the 'stock_picking.field_vol_ids' will be populated and later
    replicated in nfe40_vol field. If not triggered, the volumes will be generated
    at invoice creation (in stock.invoice.onshipping)
    """
