...
# Tipos do schema com fractionDigits=4. Os demais decimais são monetários
# (tpValor, fractionDigits=2); arredondar uma alíquota para 2 casas corromperia
# o valor (ex.: 0.029 -> 0.03).
