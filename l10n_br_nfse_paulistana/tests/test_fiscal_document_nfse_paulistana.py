...
class TestFiscalDocumentNFSePaulistana(TestFiscalDocumentNFSeCommon):
    ...
    def test_serialize_nfse_paulistana_v03(self):
        ...
        # Os bindings v03 aplicam b64encode no export da Assinatura: o valor
        # tem que ser bytes, senão o export levanta TypeError.
        self.assertIsInstance(rps.Assinatura, bytes)
        # Campos obrigatórios que só existem no layout da Reforma.
