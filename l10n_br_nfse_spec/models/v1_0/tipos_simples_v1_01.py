...
# 4 - Tomador/Intermediário emitindo por rejeitar a NFS-e emitida pelo
# prestador;
TSMOTIVOEMISTI = [
    ("1", "1"),
    ("2", "2"),
...
# 1 – o destinatário não é o próprio adquirente, podendo ser outra pessoa,
# física ou jurídica (ou equiparada), ou um estabelecimento diferente do
# indicado como tomador (tomador = adquirente ≠ destinatário);
TSRTCINDDEST = [
    ("0", "0"),
    ("1", "1"),
]
...
# objeto de reembolso, repasse ou ressarcimento pelo recebedor, já tributados e
# aqui referenciados
...
# publicidade por valores pagos relativos
...
# 99 - Outros reembolsos ou ressarcimentos recebidos por valores pagos relativos
# a operações por conta e ordem de terceiro;
TSRTCTPREEREPRES = [
    ("01", "01"),
    ("02", "02"),
    ("03", "03"),
