...
class TestNFeIBSCBS(TransactionCase):
    ...
    def test_export_field_ibscbs_exempt_line(self):
        """Test _export_field for IBSCBS on an exempt line (no amounts)"""
    ...
    def test_export_many2one_ibscbs_exempt_line(self):
        """Test _export_many2one for IBSCBS on an exempt line (no amounts)"""
        line = self._create_exempt_line()
    ...
    def test_export_fields_nfe_40_imposto_exempt_line(self):
        """Test _export_fields_nfe_40_imposto keeps IBSCBS on an exempt line"""
        line = self._create_exempt_line()
    ...
    def test_export_field_ibscbs_cst_from_tax_classification(self):
        """Test _export_field for IBSCBS takes the CST from the classification"""
        tax_classification = self.env["l10n_br_fiscal.tax.classification"].create(
            {
                "name": "Imunidade",
                "code": "410001",
