...
class DocumentImporterWizardMixin(models.TransientModel):
    ...
    def _document_key_from_binding(self, binding):
        super()._document_key_from_binding(binding)
    ...
    #         # E-IMPORT 1: Devolve o objeto a partir do XML
    ...
    #         supplier_id =
    # self._search_product_supplier_by_product_code(product.prod.cProd)
    ...
    # supplier_id.partner_uom_factor or 1,
    #         }
    ...
    #         supplier_id =
    # self._search_product_supplier_by_product_code(code)
    #         if not supplier_id:
    #             return False
    ...
    # [domain, [("default_code", "=", xml_product.cProd)]])

    #         if hasattr(xml_product, "cEANTrib") and
    #  xml_product.cEANTrib != "SEM GTIN":
    #             domain = expression.OR([domain, [
    # ("barcode", "=", xml_product.cEANTrib)]])
    ...
    #         pIPI = 0
    #         vIPI = 0
    #         icms_tags = [tag for tag in dir(product.imposto.ICMS)
    ...
    #         return {
    # "vICMS": vICMS, "pICMS": pICMS, "vIPI": vIPI, "pIPI": pIPI}
...
#         # E-IMPORT 2: Aparentemente altera os dados do XML improtado
...
#                     xml_product.prod.cEAN =
# internal_product.barcode or "SEM GTIN"
#                     xml_product.prod.cEANTrib =
#  internal_product.barcode or "SEM GTIN"
...
#     uom_conversion_factor = fields.Float(
# string="UOM Conversion Factor", default=1)
